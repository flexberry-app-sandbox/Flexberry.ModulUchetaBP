...
namespace IIS.Modul_ucheta_BP
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_ucheta_BP.Статус fСтатус;
        
        private IIS.Modul_ucheta_BP.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private IIS.Modul_ucheta_BP.Длительность fДлительность;
        
        private IIS.Modul_ucheta_BP.Клиент fКлиент;
        
        private IIS.Modul_ucheta_BP.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        ...
        public virtual IIS.Modul_ucheta_BP.Статус Статус
        {
            get
            {
                ...
                IIS.Modul_ucheta_BP.Статус result = this.fСтатус;
        ...
        public virtual IIS.Modul_ucheta_BP.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Modul_ucheta_BP.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_BP.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Modul_ucheta_BP.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Длительность"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_BP.Длительность Длительность
        {
            get
            {
                ...
                IIS.Modul_ucheta_BP.Длительность result = this.fДлительность;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_BP.Клиент Клиент
        {
            get
            {
                ...
                IIS.Modul_ucheta_BP.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Modul_ucheta_BP.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Modul_ucheta_BP.Договор));
                }
            }
        }
    }
