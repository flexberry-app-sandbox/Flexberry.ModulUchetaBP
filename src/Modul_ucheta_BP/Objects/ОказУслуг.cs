...
namespace IIS.Modul_ucheta_BP
{
    ...
    public class ОказУслуг : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_ucheta_BP.Договор fДоговор;
        
        private IIS.Modul_ucheta_BP.Услуги fУслуги;
        
        private IIS.Modul_ucheta_BP.РасчетОстВрем fРасчетОстВрем;
        ...
        [PropertyStorage(new string[] {
                "Договор"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_BP.Договор Договор
        {
            get
            {
                ...
                IIS.Modul_ucheta_BP.Договор result = this.fДоговор;
        ...
        [PropertyStorage(new string[] {
                "Услуги"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_BP.Услуги Услуги
        {
            get
            {
                ...
                IIS.Modul_ucheta_BP.Услуги result = this.fУслуги;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Modul_ucheta_BP.РасчетОстВрем.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РасчетОстВрем"})]
        public virtual IIS.Modul_ucheta_BP.РасчетОстВрем РасчетОстВрем
        {
            get
            {
                ...
                IIS.Modul_ucheta_BP.РасчетОстВрем result = this.fРасчетОстВрем;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОказУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОказУслугE", typeof(IIS.Modul_ucheta_BP.ОказУслуг));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОказУслуг : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Modul_ucheta_BP.DetailArrayOfОказУслуг members)

        // *** End programmer edit section *** (IIS.Modul_ucheta_BP.DetailArrayOfОказУслуг members)
        ...
        /// </summary>
        public DetailArrayOfОказУслуг(IIS.Modul_ucheta_BP.РасчетОстВрем fРасчетОстВрем) : 
                base(typeof(ОказУслуг), ((ICSSoft.STORMNET.DataObject)(fРасчетОстВрем)))
        {
        }
        
        public IIS.Modul_ucheta_BP.ОказУслуг this[int index]
        {
            get
            {
                return ((IIS.Modul_ucheta_BP.ОказУслуг)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Modul_ucheta_BP.ОказУслуг dataobject)
        {
