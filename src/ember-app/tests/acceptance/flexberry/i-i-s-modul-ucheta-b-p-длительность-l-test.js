...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta b p длительность l');

test('testing i-i-s-modul-ucheta-b-p-длительность-l', function(assert) {
  visit('/i-i-s-modul-ucheta-b-p-длительность-l');
