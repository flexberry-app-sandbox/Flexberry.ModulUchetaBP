...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta b p договор l');

test('testing i-i-s-modul-ucheta-b-p-договор-l', function(assert) {
  visit('/i-i-s-modul-ucheta-b-p-договор-l');
