...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta b p расчет ост врем l');

test('testing i-i-s-modul-ucheta-b-p-расчет-ост-врем-l', function(assert) {
  visit('/i-i-s-modul-ucheta-b-p-расчет-ост-врем-l');
