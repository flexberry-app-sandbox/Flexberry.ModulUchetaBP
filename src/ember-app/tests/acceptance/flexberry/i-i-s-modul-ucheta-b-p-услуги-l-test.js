...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta b p услуги l');

test('testing i-i-s-modul-ucheta-b-p-услуги-l', function(assert) {
  visit('/i-i-s-modul-ucheta-b-p-услуги-l');
