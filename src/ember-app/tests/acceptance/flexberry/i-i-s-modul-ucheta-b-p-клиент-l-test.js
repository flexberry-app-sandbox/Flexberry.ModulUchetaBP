...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta b p клиент l');

test('testing i-i-s-modul-ucheta-b-p-клиент-l', function(assert) {
  visit('/i-i-s-modul-ucheta-b-p-клиент-l');
