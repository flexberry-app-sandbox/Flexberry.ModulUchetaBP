...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta b p дир отд по раб с кл l');

test('testing i-i-s-modul-ucheta-b-p-дир-отд-по-раб-с-кл-l', function(assert) {
  visit('/i-i-s-modul-ucheta-b-p-дир-отд-по-раб-с-кл-l');
